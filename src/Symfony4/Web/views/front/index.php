<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">
            <a class="btn btn-primary btn-lg" href="/json-rpc" role="button">Documentation</a>
            <a class="btn btn-primary btn-lg" href="/json-rpc?name=admin" role="button">Documentation for admin panel</a>
        </p>
    </div>
