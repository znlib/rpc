...
class DefaultSerializer implements EncoderInterface
{

    private $attributesOnly;
    private $attributesExclude;

    public function __construct(array $attributesOnly = [], array $attributesExclude = [])
    {
    ...
    public function encode($data)
    {
        ...
        return $this->forgeRpcResponseEntity($result);
    }

    protected function forgeRpcResponseEntity($result) {
